...
#strategy = majority - os registros da classe maior muito similares a outras classes serão apagados.
#all - apaga tanto da classe maioritária quanto da outra classe.
