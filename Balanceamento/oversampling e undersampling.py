...
#UNDERSAMPLING = Diminui os registros da classe maior para ficarem na mesma quantidade da menor.
...
#OVERSAMPLING = Aumenta os registros da classe menor para ficarem na mesma quantidade da maior.
