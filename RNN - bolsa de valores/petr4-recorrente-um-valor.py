...
previsores = []
preco_real = []
for i in range(90, 1242): #1242 é o total de registros
    previsores.append(base_treinamento_normalizada[i-90:i, 0]) #não considera o 90
